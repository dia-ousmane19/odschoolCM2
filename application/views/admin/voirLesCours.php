         ...
         <div id="content">
            ...
            <div class="container-fluid">
               ...
               <div class="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 class="h3 mb-0 text-gray-800">Voir les cours</h1>
               </div>
               <div class="table-responsive">
                 <table class="table">
                  ...
                  <?php foreach ($Allchapitres as  $Allchapitre) : ?>
                  <tr>
                     <td><?= $Allchapitre['id_chapitre']  ?></td>
                     <td><?= $Allchapitre['titre_chapitre']  ?></td>
                     <td><?= $Allchapitre['contenu_chapitre']  ?></td>
                     <td><?= $Allchapitre['link_chapitre']  ?></td>
                     <td><?= $Allchapitre['date']  ?></td>
                     <td><a href="" class="btn m-1  btn-info" title="Modifier"><i class="fas fa-edit"></i></a> <a href="" title="Supprimer"  class="btn m-1  btn-danger"><i class="fas fa-trash"></i></a></td>
                  </tr>
               <?php endforeach; ?>
